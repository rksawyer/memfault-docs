...
Optionally, as requirements of our [OTA system][docs-linux-ota]:
...
Add the necessary dependencies to your image file:
...
```
PACKAGECONFIG := "plugin-swupdate plugin-reboots"
```

Alternatively, in your `local.conf` file:

```
PACKAGECONFIG:pn-memfaultd := "plugin-swupdate plugin-reboots"
```
...
alongside `-DPLUGIN_REBOOT=1` and `-DPLUGIN_SWUPDATE=1`.
...
[source-yocto-example]:
  https://github.com/memfault/memfault-linux-sdk/tree/master/meta-memfault-example
[source-yocto-memfault-device-info-example]:
  https://github.com/memfault/memfault-linux-sdk/blob/master/meta-memfault-example/recipes-memfault/memfault-device-info/memfault-device-info.bb
[source-yocto-memfaultd-conf-example]:
  https://github.com/memfault/memfault-linux-sdk/blob/master/meta-memfault-example/recipes-memfault/memfaultd/memfaultd.bbappend
[source-memfaultd]:
  https://github.com/memfault/memfault-linux-sdk/tree/master/meta-memfault/recipes-memfault/memfaultd/files/memfaultd
[source-builtin-conf]:
  https://github.com/memfault/memfault-linux-sdk/tree/master/meta-memfault/recipes-memfault/memfaultd/files/memfaultd/builtin.conf
[source-meta-memfault]:
  https://github.com/memfault/memfault-linux-sdk/tree/master/meta-memfault
