...
- Device ID/Device Serial: a unique identifier of a device. For example, this
  may be a serial number written into the EEPROM of your product in the factory
  or a chip identifier present in the silicon of the main MCU on your platform.
  This identifier _must_ be unique for every device in the same Project.
