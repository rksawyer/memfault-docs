...
![/img/docs/platform/navigating-orgs.png](/img/docs/platform/navigating-orgs.png)
...
- Deploy new firmware/software updates to parts of your
  ...
  [MCU](../mcu/releases-integration-guide.mdx) or
  [Linux](../linux/linux-releases-integration-guide) Fleet
