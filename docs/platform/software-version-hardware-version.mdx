...
If you're interested in learning how Memfault decides which OTA Release to
deliver to a specific device, refer to the
[Updating Behavior section on our platform-agnostic OTA documentation page](/docs/platform/ota#updating-behavior).
