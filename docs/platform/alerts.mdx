...
select the Alert you want. Incidents are listed per device. A notification will
also get sent out at the times configured under the schedule summary, to the
specified targets.
