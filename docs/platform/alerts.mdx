...
![Creating an Alert in the Memfault app](/img/docs/platform/alerts-create-min.png)
...
<p align="center">
  <img
    width="600"
    src="/img/docs/platform/alerts-incidents-min.png"
    alt="/img/docs/platform/alerts-incidents-min.png"
  />
</p>
