...
To log in with SSO, click on the **Log in with SAML SSO** link, and you'll be
prompted to enter your email address. Make sure to enter the email address
provided by your organization.

<p align="center">
  <img
    width="800"
    src="/img/docs/platform/login-with-saml-form-min.png"
