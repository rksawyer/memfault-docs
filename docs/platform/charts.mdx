...
Please note that this particular type of chart supports only the Min/Mean/Max
aggregation method.
...
[Metric Charts by Software Version or Cohort](#metric-charts-by-software-version-or-cohort)
or
[Issue Charts by Software Version or Cohort](#issue-charts-by-software-version-or-cohort)
instead.
