...
<p align="center">
  <img
    width="500"
    src="/img/docs/platform/jira-integration-project-settings-min.png"
...
- To find the Issue Type ID's, login to Jira in the browser and then navigate to
  ...
  response is returned, the desired field is labeled `id`.
...
<p align="center">
  <img
    width="700"
    src="/img/docs/platform/jira-integration-jira-min.png"
    alt="/img/blog/issue-filtering"
  />
</p>
...
<p align="center">
  <img
    width="500"
    src="/img/docs/platform/jira-integration-issue-min.png"
    alt="/img/blog/issue-filtering"
  />
</p>
