...
Please contact us at support@memfault.com if you want to use a custom name that
is different from the technical id reported by the devices for a metric across
[Charts](/docs/platform/charts), [Alerts](/docs/platform/alerts) and Device
Timeline.
