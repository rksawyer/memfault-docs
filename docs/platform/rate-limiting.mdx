...
Memfault employs rate limiting to prevent malfunctioning devices
from causing excessive amounts of traffic on the platform, which in turn
improves site stability. Rate limits also help us provide fair pricing to our
customers.
  ...
  <tbody>
    <tr id="custom-reports">
      ...
      <td>
        ...
        built on top of Custom Reports.
      </td>
    </tr>
    ...
    <tr id="reboot-events">
      ...
      <td>
        ...
        <Link to="/docs/mcu/reboot-reason-tracking/">
          Reboot Reason Tracking subsystem
        </Link>{" "}
        (MCU).
      </td>
    </tr>{" "}
    ...
    <tr id="bug-reports">
      ...
      <td>Android</td>
      <td>
        <Link to="/docs/android/uploading-android-bugreports">Bug Reports</Link>{" "}
