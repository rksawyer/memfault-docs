...
In this guide we will walk through how to add some initial data collection leveraging Memfault
...
With data collection verified locally, the final step is sending the data progamatically to the Memfault cloud.
