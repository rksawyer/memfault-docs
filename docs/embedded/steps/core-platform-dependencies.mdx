Open the `memfault_platform_port.c` file created in
`third_party/memfault/memfault_platform_port.c`. This will be the file we
implement the platform dependencies required by the SDK. You can copy the
template below into your project and fill in accordingly.
