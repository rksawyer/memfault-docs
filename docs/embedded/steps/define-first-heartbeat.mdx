Heartbeat metrics allow you to easily monitor a system for marginality issues
and to ensure things are running as expected.
...
MEMFAULT_METRICS_KEY_DEFINE(MainTaskWakeups,
