...
[can be found here](/docs/embedded/data-from-firmware-to-the-cloud). In short,
the Memfault SDK packetizes data into "chunks" that must be pushed to the
Memfault cloud via the
