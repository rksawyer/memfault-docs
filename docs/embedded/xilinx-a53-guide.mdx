...
import TimerDependencies from "./_steps/timer-dependencies.mdx";
import AcrhitectureDependencies from "./_steps/arch-dependencies.mdx";
import RebootReasonDependency from "./_steps/reboot-reason-dependency.mdx";
