...
```bash
python ./sdk/middleware/memfault/memfault-firmware-sdk/scripts/eclipse_helper.py -p ${YOUR_PROJECT_ROOT} -m sdk/middleware/memfault/memfault-firmware-sdk --target-port dialog/da1469x
```
