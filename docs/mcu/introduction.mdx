...
- [Reboot Reason Tracking](/docs/mcu/reboot-reason-tracking) - allows one to
  ...
  brown out, crash or a firmware update). Summaries and aggregates and then be
  viewed from the Memfault web application.
