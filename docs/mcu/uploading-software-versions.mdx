...
[More information on this concept can be read here.](/platform/software-version-hardware-version.mdx)
...
3. Click **New Software Type** in the top right corner
   ...
   ![/img/docs/mcu/software-versions-create-type.png](/img/docs/mcu/software-versions-create-type.png)
...
4. Input the name of the **Software Type**, assuring that it only contains
   ...
   ![/img/docs/mcu/software-versions-input-name.png](/img/docs/mcu/software-versions-input-name.png)
...
2. In `mcu-main-fw`'s row, click `... versions` in the **Versions** column
   ...
   ![/img/docs/mcu/software-versions-versions-column.png](/img/docs/mcu/software-versions-versions-column.png)

3. Click **New Version**

   ![/img/docs/mcu/software-versions-new-version.png](/img/docs/mcu/software-versions-new-version.png)
...
4. Select **symbols** from the **Type** dropdown.
   ...
   ![/img/docs/mcu/software-versions-symbols-add.png](/img/docs/mcu/software-versions-symbols-add.png)
...
5. In the table of versions for `mcu-main-fw`, you will now see the newly
   ...
   ![/img/docs/mcu/software-versions-newly-created.png](/img/docs/mcu/software-versions-newly-created.png)
