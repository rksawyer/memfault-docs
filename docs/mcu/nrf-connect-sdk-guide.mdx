...
releases ranging from v1.4.0 up to v2.2.0. All versions of the nRF Connect SDK
...
released some
[excellent documentation](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.2.0/nrf/libraries/others/memfault_ncs.html)
on how to integrate Memfault in your existing nRF Connect SDK project, together
with a
[sample integration project](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.2.0/nrf/samples/nrf9160/memfault/README.html).
...
[nRF Connect SDK Environment](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.2.0/nrf/getting_started.html)
...
See the
[nRF Connect Docs](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.2.0/nrf/libraries/others/memfault_ncs.html#configuration-files)
...
<https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.2.0/nrf/libraries/bluetooth_services/services/mds.html>

There is also a sample application, "Bluetooth LE: Peripheral Memfault
Diagnostic Service (MDS)", documented here:

<https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.2.0/nrf/samples/bluetooth/peripheral_mds/README.html>
...
- [`CONFIG_MEMFAULT_NCS_LTE_METRICS`](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.2.0/kconfig/#CONFIG_MEMFAULT_NCS_LTE_METRICS)
- [`CONFIG_MEMFAULT_NCS_STACK_METRICS`](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.2.0/kconfig/#CONFIG_MEMFAULT_NCS_STACK_METRICS)
...
- [nRF52/nRF53 example Memfault integration](https://github.com/memfault/memfault-firmware-sdk/tree/0.37.0/examples/nrf-connect-sdk/nrf5)
- [nRF9160 example Memfault integration](https://github.com/memfault/memfault-firmware-sdk/tree/0.37.0/examples/nrf-connect-sdk/nrf9160)
- [Nordic maintained nRF9160 example Memfault integration](https://github.com/nrfconnect/sdk-nrf/tree/v2.2.0/samples/nrf9160/memfault)
- [Nordic maintained Asset Tracker v2 Application for nRF9160](https://github.com/nrfconnect/sdk-nrf/tree/v2.2.0/applications/asset_tracker_v2)

  - see the documentation for
    [how to build with Memfault enabled](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.2.0/nrf/applications/asset_tracker_v2/doc/asset_tracker_v2_description.html#configuration-files)

Nordic Memfault Documentation:

- [nRF Connect SDK documentation on built-in Memfault Firmware SDK integration](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/2.2.0/nrf/libraries/others/memfault_ncs.html)
...
- <https://github.com/nrfconnect/sdk-nrf/blob/v2.2.0/west.yml#L171-L174>
