...
interest for debugging purposes. Your application and systems code can leverage
this to log crucial information and get it surfaced in the Memfault UI.
...
Note that the `StructuredLog.dump()` API is only available on debug builds of
