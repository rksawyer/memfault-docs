...
If your devices will have [Google Mobile Services (GMS)](https://www.android.com/intl/en_ca/gms/)
and must run the [Compatibility Test Suite (CTS)](https://source.android.com/compatibility/cts),
you may need to **update the Bort target SDK version** to match the API level of your OS.
This can be done by updating the `TARGET_SDK_VERSION` property in
