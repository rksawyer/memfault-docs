...
[Software Version](platform/software-version-hardware-version.mdx) documentation.
...
This is a token that is used when pushing data between a device and the
...
-> "General" page in the Memfault UI and copy/paste the token in the "Project Key"
section.
