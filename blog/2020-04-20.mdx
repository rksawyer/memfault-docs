...
- Add support for showing logs in the Issue detail view if the device is
  compiled and uses the Memfault Logging SDK.
  <p align="center">
    <img
      width="400"
      src="/img/blog/2020-04-20-device-logs-min.png"
      alt="device-logs"
    />
  </p>
...
- In the Timeline view, Memfault shows the "Foreground Activity" at any given
  time
  <p align="center">
    <img
      width="400"
      src="/img/blog/2020-04-20-foreground-activity-min.png"
      alt="foreground-activity"
    />
  </p>
...
- Allow cross-region S3 uploads to speed up initial uploads. If this is a
