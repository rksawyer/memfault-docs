...
There is also a new [Getting Started](/docs/linux/integration-guide) section
that guides users through the setup with Yocto, and the
...
- Added: [Getting Started Guide](/docs/linux/integration-guide) and Reference
  pages for
  [memfaultd Configuration](/docs/linux/reference-memfaultd-configuration/) and
  [memfaultd CLI](/docs/linux/reference-memfaultctl-cli)
- First
  [public SDK version 0.2.0](https://github.com/memfault/memfault-linux-sdk/blob/-/CHANGELOG.md)
