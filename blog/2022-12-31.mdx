...
[Using Memfault with Low-Bandwidth Devices](/docs/best_practices/low-bandwidth-devices/)
...
- Added:
  [Documentation on best practices when using Memfault with low-bandwidth devices](/docs/best_practices/low-bandwidth-devices)
- Added:
