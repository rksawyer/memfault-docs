...
- Added:
  [Documentation of when reads and writes happen to Linux SDK `data_dir`](/docs/linux/linux-getting-started-guide#configure-a-persistent-storage-directory-for-memfaultd)
